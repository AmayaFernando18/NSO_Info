...
import { LayoutDashboard, Newspaper, ShieldCheck, Image, ArrowLeft, LogOut, Calendar, Users, Link2, Download } from 'lucide-react'
...
export default function AdminLayout() {
  ...
  const allLinks = [
    ...
    { to: '/admin/downloads', label: 'Downloads', icon: Download, requirePermission: RBAC_FUNCTION.DOWNLOADS },
