        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <Logo size="large" />
              <div>
                <h3 className="text-2xl font-bold text-white">NSO</h3>
                <p className="text-base text-gray-200">National System Operator (Pvt) Ltd</p>
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-2.5 text-base text-white mb-4">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold mb-4 text-white text-xl">Quick Links</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="font-bold mb-4 text-white text-xl">Resources</h4>
            <ul className="space-y-3 text-base text-white">
              <li>
